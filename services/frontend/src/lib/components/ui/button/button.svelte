	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline_primary:
					'bg-background shadow-xs text-[#936DFF] hover:bg-[#936DFF] hover:text-accent-foreground dark:bg-linear-to-l from-[#3A0480]/16 to-[#4C098E]/50  border dark:border-[#E9E9E9]/20 transition-all duration-300',
				secondary: 'border border-[#5D6A83]/40 bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 hover:border-[#5D6A83]',
